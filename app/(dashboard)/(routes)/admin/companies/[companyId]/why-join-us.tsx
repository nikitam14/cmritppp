...
export const WhyJoinUsForm = ({
  ...
  const handlePromptGeneration = async () => {
    try {
      setIsPrompting(true);
      const customPrompt = `Create a compelling "Why Join Us" content piece for ${rolename}. Highlight the unique opportunities, benefits, and experience that ${rolename} offers to its users. Emphasize the platform's value proposition, such as access to a vast music library, personalized recommendations, exclusive content, community features and career opportunites for musicians and creators. Tailor the content to attract potential users and illustrate why ${rolename} stands out among other streaming platofrms`;
